...
import com.example.qrcodescanner.camera.CameraManager;
import com.example.qrcodescanner.decode.CaptureActivityHandler;
import com.example.qrcodescanner.decode.DecodeImageCallback;
import com.example.qrcodescanner.decode.DecodeImageThread;
import com.example.qrcodescanner.decode.DecodeManager;
import com.example.qrcodescanner.decode.InactivityTimer;
import com.example.qrcodescanner.view.QrCodeFinderView;
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.qr_code_iv_flash_light) {
            if (mNeedFlashLightOpen) {
                turnFlashlightOn();
              //  Toast.makeText(mApplicationContext, "turn flashlight on", Toast.LENGTH_SHORT).show();
            } else {
                 turnFlashLightOff();
               // Toast.makeText(mApplicationContext, "turn flashlight off", Toast.LENGTH_SHORT).show();
            }
            ...
            if (!hasCameraPermission()) {
                ...
                openSystemAlbum();
                //Toast.makeText(mApplicationContext, "open album", Toast.LENGTH_SHORT).show();
            }
